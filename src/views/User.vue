                ...
                <v-tabs-items v-model="tabs">
                  ...
                  <v-tab-item key="transactions" value="transactions">
                    <v-card id="transactions-card" flat>
                      ...
                      >
                        <template slot="items" slot-scope="props">
                          <td>{{ new Date(props.item.created_at).toLocaleString() | moment("from", "now") }}</td>
                          <td class="text-xs-right">{{ props.item.transaction_type }}</td>
                          <td class="text-xs-right">{{ props.item.meme.title }}</td>
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch(GET_TRANSACTIONS, { username: this.$route.params.username });
  },
  computed: {
    user() {
